...
- AWS CLI instalado ([Guia de Instalação](https://docs.aws-sdk.org/cli/latest/userguide/getting-started-install.html))
...
3. O navegador será aberto para que você faça o login com suas credenciais corporativas.
