---
name: pac-mission-control-knowledge
description: Contexto abrangente, arquitetura, design visual, SQL Athena, regras de negócio e edge cases do projeto PAC Mission Control. Ponto de partida obrigatório para qualquer LLM trabalhando no projeto.
---

# 🧠 Contexto e Regras do Projeto: PAC Mission Control

**Objetivo deste documento:** Servir como base de conhecimento (prompt de contexto) e skill principal para qualquer IA que for auxiliar no desenvolvimento, manutenção ou análise de dados do projeto **PAC Mission Control**. Leia atentamente as regras abaixo antes de sugerir ou escrever qualquer código.
...
**Nota:** Para suporte operacional, treinamento do CCO e fluxos visuais, utilize a skill `pac-operational-manual`.
